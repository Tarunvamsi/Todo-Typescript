...
const CreateTask: React.FC<CreateTaskProps> = ({
  ...
  return (
      <div className="className= p-4 m-3 w-3/4 ml-44  flex flex-wrap  bg-gradient-to-r from-gray-800 via-gray-700 to-gray-600  shadow-gray-300 shadow-sm  rounded-lg">
